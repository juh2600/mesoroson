...
class Participant {
	...
	constructor(name, type, mind, distributor, options = {}) {
		...
		/**
		 * Custom function used to refresh the list of channels to which this Participant should be listening. This function does not actually join the channels.
		 */
		this.refresh_channels = o.refresh_channels;

		/**
		 * Custom function to reload this Participant. This function is intended to contain platform-specific operations, such as joining newly added channels. (It would make sense in some situations to call refresh_channels() at the top of this function.)
		 */
